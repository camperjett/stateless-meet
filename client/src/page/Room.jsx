...
import { BsCameraReelsFill as RecordIcon } from "react-icons/bs";
import { BsCameraReels as StopRecordIcon } from "react-icons/bs";
          ...
          border-2  p-2 cursor-pointer rounded-xl text-white text-xl`}
                        ...
                        <div>
                          <button
                            ...
                            onClick={async (e) => {
                              if(record === 0) await startRecording(e);
                              else if(record === 1){
